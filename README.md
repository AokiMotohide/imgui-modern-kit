...
ImKit code is MIT. Dear ImGui and Gallery-only dependencies retain their own licenses. Optional font and icon provenance is recorded in [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).
