...
[日本語](build-first-app.ja.md) · [Documentation index](README.md) · [How ImKit works](how-it-works.md)
...
Everything is host-owned. ImKit only draws and reports — see [How ImKit works](how-it-works.md) for the ownership model.
...
1. To see ImKit in a real window today, build and run the **Gallery** — it renders every control in this guide:
   ...
   On macOS, use the `macos-universal` preset (Release, arm64/x86_64). See [Gallery](gallery.md).
