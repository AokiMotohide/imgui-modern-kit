...
[日本語](基本コンポーネント.md) · [Documentation index](../README.md)
...
Notification expiry and removal belong to the host. More overload-level details are in [API coverage](../reference/api-coverage.md).
