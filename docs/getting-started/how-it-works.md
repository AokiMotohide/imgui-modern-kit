...
- [Build your first ImKit app](../tutorials/build-first-app.md) — a full, runnable walkthrough.
- [Architecture](../architecture/architecture.md) — the authoritative ownership and design reference.
