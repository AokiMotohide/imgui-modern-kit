...
[日本語](エディタAPI.md) · [English](editor-api.md)
...
See [timeline editing contracts](../components/timeline-editing.md) for fields, gestures and host ownership.
...
Gallery applies only the subset documented in [editor-suite.md](../components/editor-suite.md).
...
Editor 2.0の移行と操作設計は[こちら](../archive/editor-refresh.md)を参照してください。
